...
1.  **Install Python**: Download the latest version from [python.org](https://www.python.org/downloads/).
2.  **Code Editor**: We recommend [VS Code](https://code.visualstudio.com/) for the best experience (with the Python extension installed).
